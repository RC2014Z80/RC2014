...
For convenience, because we can't easily change ROM code interrupt routines already present in the RC2014, the serial Tx and Rx routines are reachable by calling `RST` instructions.
