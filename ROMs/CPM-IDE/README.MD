...
<tr>
<th style="border: 1px solid #cccccc; padding: 6px;"><centre>RC2014 CP/M-IDE Hardware<center></th>
</tr>
</tbody>
</table>
</div>
...
9. [SIO board](https://rc2014.co.uk/modules/dual-serial-module-sio2/)

## Configuration

The cards are configured in their normal settings for CP/M. A jumper for the "Page" signal is made on pin 39, although this can be done in any alternative way.
...
```bash
zcc +rc2014 -subtype=acia -SO3 -llib/rc2014/ff --max-allocs-per-node200000 @cpm22.lst -o rc2014-cpm22 -create-app
...
<tbody>
<tr>
<td style="border: 1px solid #cccccc; padding: 6px;"><a href="https://github.com/RC2014Z80/RC2014/blob/master/ROMs/CPM-IDE/docs/cpm-idev2.png" target="_blank"><img src="https://github.com/RC2014Z80/RC2014/blob/master/ROMs/CPM-IDE/docs/cpm-idev2.png"/></a></td>
</tr>
<tr>
