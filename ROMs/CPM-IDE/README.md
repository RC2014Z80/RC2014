...
```bash
zcc +rc2014 -subtype=acia -SO3 -llib/rc2014/ff --math32 --max-allocs-per-node2000000 @cpm22.lst -o ../rc2014-acia-cpm22 -create-app

zcc +rc2014 -subtype=sio -SO3  -llib/rc2014/ff --math32 --max-allocs-per-node2000000 @cpm22.lst -o ../rc2014-sio-cpm22 -create-app
```
