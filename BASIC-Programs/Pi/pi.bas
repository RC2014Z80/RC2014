5  PRINT "Pi Calculation Example"
10 INPUT "How many digits do you want";N
20 CR=0
30 LN=INT(10*N/3)+16
40 ND=1
50 DIM A(LN)
...
500 IF ND=0 AND CR<24 THEN PRINT STR$(D);:CR=CR+1: RETURN
502 IF ND=0 AND CR=24 THEN PRINT STR$(D):CR=0: RETURN
