...
JJ is displacement required in a Jump Relative instruction which starts at xxxx, to cause a jump to yyyy. Value in Decimal.
...
Execute program at xxxx, supplying integer input parameter yyyy. Values in Hexadecimal.
